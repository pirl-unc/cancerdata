#!/usr/bin/env python
"""Build checksum-pinned direct GEO references for selected NCI-gap cancers."""
...
from oncoref.expression_source_adapters import (
    build_gse125285_source_matrices,
    build_gse139682_source_matrices,
)

BUILDERS = {
    "gse125285-bcc-cscc": build_gse125285_source_matrices,
    "gse139682-gbc": build_gse139682_source_matrices,
}


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("source_id", choices=sorted(BUILDERS))
