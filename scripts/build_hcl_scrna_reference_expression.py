#!/usr/bin/env python
"""Build five donor-level HCL T0 pseudobulks from Zenodo record 14917813."""
...
from oncoref.expression_source_adapters import build_hcl_source_matrices
...
def main(argv: list[str] | None = None) -> int:
    ...
    cache = args.cache_dir or (
        Path.home() / ".cache" / "oncoref" / "expression" / "zenodo-14917813-hcl"
    )
    result = build_hcl_source_matrices(
        cache_dir=cache,
